...
export default async function DashboardPage() {
  ...
  const recentBattleCards = [
    {
      id: "1",
      title: "Passwordless Access for Law Firms",
      summary: "Sales battle card for MSP partners to use when speaking with law firms.",
      competitor: "N/A",
      industry: "Legal",
      updatedAt: new Date(),
      tags: [{ tag: { id: "1", name: "security" } }],
    },
  ];
  ...
  const recentAnnouncements = [
    {
      ...
      contentMarkdown: "We are live. Start with **Battle Cards** for competitor intel.",
      createdAt: new Date(),
    },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Card className="border-zinc-800/60 bg-zinc-900/50">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-zinc-100">{recentBattleCards.length}</div>
          ...
          <Card className="border-zinc-800/60 bg-zinc-900/50">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-zinc-100">{recentAnnouncements.length}</div>
